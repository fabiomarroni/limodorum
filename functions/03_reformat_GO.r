...
option_list = list(
  make_option(c("-I", "--infile"), type="character", default="",help="Original GO file [default= %default]", metavar="character"), 
  make_option(c("-O", "--out"), type="character", default="", help="output file (contains reofrmatted GO/genes association) [default= %default]", metavar="character")
)
